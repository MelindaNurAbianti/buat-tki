...
public class User {
    ...
    //Read password false harusnya ada di database
    //Dia selalu ngeloop data, walaupun hasilnya udah ketemu dia terus ngelooping jadi nilainya selalu false
    //solusi : tambahin break (pada line 148)
